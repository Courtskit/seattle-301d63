...
// this is referring to the object of joe, console logging its properties
// 2. What is "this" when joe.scopeArrow() is invoked?
// this is referring to the entire window of this JS file
// 3. Explain why "this" is different when an arrow function is used.
// this is not locally handled within this arrow function because it skips its first parent object, it takes the next parent object which happens to be the window object in this example
